...
## Topic Weightage Source (Estimated)
No official fixed topic-wise % is published by GATE. This planner uses PYQ-trend estimates from:
- https://www.careers360.com/exams/gate/gate-cse-syllabus-and-exam-pattern
- https://www.pw.live/gate/gate-cse-syllabus

Use this as direction for time allocation, not guaranteed marks split.
...
- `script.js` - planner logic + localStorage persistence
...
## Notes
Checkbox progress and difficulty selections are saved in browser localStorage.
